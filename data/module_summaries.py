MODULE_SUMMARIES = {
    1: {
        ...
        "vocabulary": [
            ...
            "normative statement", "budget constraint", "feasible set",
            "production possibilities model", "comparative advantage", "models as maps",
        ],
    },
    2: {
        "summary": (
        ...
        "vocabulary": [
            ...
            "marginal rate of substitution", "optimal bundle", "feasible frontier",
            "labor-leisure choice", "intertemporal choice", "bounded rationality",
            "present bias", "capabilities approach",
        ],
    },
    3: {
        "summary": (
        ...
        "vocabulary": [
            ...
            "demand schedule", "supply schedule", "market equilibrium", "market-clearing price",
            "shortage", "surplus", "shift in demand", "shift in supply", "double shift",
        ],
    },
    4: {
        "summary": (
        ...
        "vocabulary": [
            ...
            "income elasticity", "cross-price elasticity", "total revenue",
            "consumer surplus", "producer surplus", "total surplus", "deadweight loss",
            "price floor", "price ceiling", "tax incidence",
        ],
    },
    5: {
        "summary": (
        ...
        "vocabulary": [
            ...
            "value of marginal product", "wage rate", "land rent", "loanable funds",
            "interest rate", "perfectly inelastic supply", "monopsony",
        ],
    },
    6: {
        "summary": (
        ...
        "vocabulary": [
            ...
            "capital deepening", "Great Divergence", "GDP", "wellbeing",
            "Kuznets curve", "externality", "social cost of carbon",
        ],
    },
    7: {
        "summary": (
        ...
        "vocabulary": [
            ...
            "monopsony", "value of marginal product", "wage discrimination",
            "principal-agent problem", "moral hazard", "payoff matrix",
            "dominant strategy",
        ],
    },
    8: {
        ...
        "vocabulary": [
            ...
            "disparate impact", "algorithmic audit", "fairness constraint",
            "environmental racism", "climate justice", "distributional injustice",
            "just transition",
        ],
    },
    9: {
        ...
        "vocabulary": [
            ...
            "production function", "total product", "marginal product", "fixed cost",
            "variable cost", "average total cost", "marginal cost", "short run",
    ...
    10: {
        ...
        "vocabulary": [
            ...
            "profit maximization", "MR = MC", "shutdown rule", "average variable cost",
            "long-run equilibrium", "entry and exit", "monopoly", "price maker",
            "price discrimination", "monopoly deadweight loss",
        ],
    },
    11: {
        "summary": (
        ...
        "vocabulary": [
            ...
            "Herfindahl-Hirschman Index", "concentration ratio", "payoff matrix",
            "dominant strategy", "Nash equilibrium", "prisoner's dilemma",
            "collusion", "cartel", "repeated game",
        ],
    },
    12: {
        "summary": (
        ...
        "vocabulary": [
            ...
            "externality", "Pigouvian tax", "Pigouvian subsidy", "Coase theorem",
            "cap-and-trade", "tax incidence", "public-goods game",
            "behavioral policy", "human development index", "wellbeing economics",
        ],
    },
}
